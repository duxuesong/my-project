...
(function(global, factory) {
			...
			function read() {
				...
				return length < 0 || (type && type !== that._type) ? skip() : that._source.slice(length).then(function(chunk) {
					return {
						...
						value: type ? that._parse(view(concat$1(array.slice(8), chunk))) : null
					};
				});
			}
	...
	function Shp(source, header) {
		...
		this.bbox = [header.getFloat64(36, true), header.getFloat64(44, true), header.getFloat64(52, true), header.getFloat64(
			60, true)];
	}
