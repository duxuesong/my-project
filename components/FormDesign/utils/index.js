...
export default {
  ...
  getFormatDate (formatType, formatDate) {
    ...
    month = month >= 1 && month <= 9 ? (month = '0' + month) : ''
    strDate = strDate >= 0 && strDate <= 9 ? (strDate = '0' + strDate) : ''
    minutes = minutes >= 0 && minutes <= 9 ? (minutes = '0' + minutes) : ''
    seconds = seconds >= 0 && seconds <= 9 ? (seconds = '0' + seconds) : ''
